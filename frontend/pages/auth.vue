  ...
  <div id="AuthPage" class="w-full h-[100vh] bg-white">
    <div class="max-w-[400px] mx-auto px-2">
      <div class="text-center my-4">
        <button @click="showLogin = true" :class="{ 'font-bold': showLogin }" data-testid="login-button">Login</button>
        <span class="mx-2">/</span>
        <button @click="showLogin = false" :class="{ 'font-bold': !showLogin }" data-testid="register-button">Register</button>
      </div>

      <!-- Hiển thị lỗi -->
      <div v-if="errorMessage" data-testid="error-message" class="text-red-500 text-sm">
        {{ errorMessage }}
      </div>
      ...
      <form v-if="showLogin" @submit.prevent="loginWithEmail">
        ...
        <button :disabled="isLoading" type="submit" data-testid="login-button-submit" class="w-full p-2 bg-blue-500 text-white rounded">
      ...
      <form v-else @submit.prevent="registerWithEmail" >
        ...
        <button :disabled="isLoading" type="submit" data-testid="register-button-submit" class="w-full p-2 bg-green-500 text-white rounded">
