  ...
  >
    <NuxtLink :to="`item/${product.id}`">
      <div class="relative flex flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md">
        ...
        <div class="m-2 px-1 flex flex-col justify-between flex-grow">
          <a href="#">
            <h5 class="text-lg font-semibold tracking-tight text-slate-900">{{ product.title }}</h5>
          </a>
          ...
          <div class="flex items-center justify-between">
            ...
            <NuxtLink
              :to="`/item/${product.id}`"
              class="flex items-center justify-center rounded-md bg-[#FD374F] px-2.5 py-2 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="mr-2 h-6 w-6"
